...
-- 정답:
SELECT name AS 제품명, price AS 가격 FROM products WHERE price >= 300000;
...
-- 정답:
SELECT name AS 제품명, stock AS 재고 FROM products WHERE category='전자기기' AND stock >= 10;
...
-- 정답:
SELECT name AS 제품명, price * 1.1 AS '10% 세금 적용' FROM products;
...
-- 정답:
SELECT name AS 제품명, category AS 카테고리 FROM products WHERE NOT category='전자기기';
...
-- 정답:
SELECT name AS 제품명, price * 0.8 AS 가격 FROM products WHERE stock <= 10;
...
-- 정답: 
SELECT name AS 제품명, category AS 카테고리, stock AS 재고 FROM products 
...
-- 정답:
SELECT name AS 제품명, stock AS 재고, (price * 0.7) AS '할인된 가격' FROM products 
