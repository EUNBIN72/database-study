...
-- 정답:
SELECT name, salary FROM employees WHERE department='개발';
...
-- 정답:
SELECT name, department FROM employees WHERE position='팀장';
...
-- 정답:
UPDATE employees SET salary = salary + 300000 WHERE department = '영업';
