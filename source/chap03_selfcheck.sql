...
-- ---------------------
-- 버거 이름  | 100g당 가격
SELECT name AS '버거 이름', (price / gram) * 100 AS '100g당 가격' FROM burgers;
...
-- -------------------------
-- 버거 이름  | 1000원당 단백질량
SELECT name AS '버거 이름', (protein / price) * 1000 AS '1000원당 단백질량' FROM burgers;
...
-- 버거 이름  | 1000원당 단백질량
-- -------------------------
SELECT name AS '버거 이름', (protein / price) * 1000 AS '1000원당 단백질량' FROM burgers WHERE ((protein / price) * 1000) >= 5;
